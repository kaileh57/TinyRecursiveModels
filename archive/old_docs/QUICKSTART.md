# ⚠️ DEPRECATED - Use QUICKSTART_JAX.md Instead

**This guide is OUTDATED and references PyTorch/XLA which is no longer used.**

**→ See [QUICKSTART_JAX.md](QUICKSTART_JAX.md) for the correct JAX-based setup guide.**

---

# TRM Scaling Research - Quick Start Guide (DEPRECATED)
